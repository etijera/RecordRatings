...
namespace GLReferences
{
    public class DBHelper
    {
        ...
        public static DataSet ExecuteDataSet(string sqlSpName, SqlParameter[] dbParams)
        {
            ...
            {
                XtraMessageBox.Show("Ha ocurrido un error al intentar conectarse con el servidor.\n Por favor verifique la conexión o comuniquese con el administrador del sistema.", Resources.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
                //throw;                
            }
            return ds;
        }
